...
function removeProp($target, name, value) {
  if (isCustomProp(name)) return
  else if (name === 'className') $target.removeAttribute('class')
...
const f = ( <ul style = "list-style: none">
<li className = "item" onClick = {() => alert('hi!')}>item 1</li>
<li className = "item" >
  <input type = "checkbox" checked = {true}/>
  <input type = "text" onInput = {log}/>
</li>
{ /* this node will always be updated */ }<li forceUpdate = {true} >text</li>
</ul>
)
...
<li forceUpdate = {true}>text</li></ul>
)
